...
// import { generateMission, getAllChats, saveChat, deleteChat as deleteChatAPI } from '../services/api';
...
//           // Convert MongoDB chats to frontend format
//           const convertedChats = savedChats.map(chat => ({
...
//         // Fallback to empty chat on error
//         const initialChat = {
//           id: Date.now(),
//           name: 'New Chat',
//           messages: [],
                      ...
                      <>
                        ...
                        {message.missionData && (
                          <div className="space-y-4">
                            ...
                            {/* ⭐ NEW SECTION 1: Payload & Sensors */}
                            {message.missionData.payload && (
                              <div className="bg-slate-800/50 rounded-xl p-5 border border-cyan-500/30">
                                <h4 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                                  <span>📷</span> Payload & Sensors
                                </h4>
                                ...
                                <div className="space-y-3">
                                  <div className="flex justify-between items-center p-3 bg-slate-700/30 rounded-lg">
                                    ...
                                    <span className="font-semibold text-white">
                                      {message.missionData.payload.type}
                                    </span>
                                  </div>

                                  {message.missionData.payload.resolution_m && (
                                    <div className="flex justify-between items-center p-3 bg-slate-700/30 rounded-lg">
                                      <span className="text-gray-400">Resolution:</span>
                                      <span className="font-semibold text-cyan-400">
                                        {message.missionData.payload.resolution_m}m
                                      </span>
                                    </div>
                                  )}
                                  ...
                                  <div className="flex justify-between items-center p-3 bg-slate-700/30 rounded-lg">
                                    ...
                                    <span className="font-semibold text-white">
                                      {message.missionData.payload.mass_kg} kg
                                    </span>
                                  </div>
                                  ...
                                  <div className="flex justify-between items-center p-3 bg-slate-700/30 rounded-lg">
                                    ...
                                    <span className="font-semibold text-yellow-400">
                                      {message.missionData.payload.power_w} W
                                    </span>
                                  </div>

                                  {message.missionData.payload.swath_width_km && (
                                    <div className="flex justify-between items-center p-3 bg-slate-700/30 rounded-lg">
                                      <span className="text-gray-400">Swath Width:</span>
                                      <span className="font-semibold text-purple-400">
                                        {message.missionData.payload.swath_width_km} km
                                      </span>
                                    </div>
                                  )}
                                </div>
                            ...
                            {/* ⭐ NEW SECTION 2: Data & Communications */}
                            {message.missionData.data && (
                              <div className="bg-slate-800/50 rounded-xl p-5 border border-cyan-500/30">
                                <h4 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                  <div className="p-3 bg-slate-700/30 rounded-lg">
                                    <p className="text-xs text-gray-400">Daily Data Volume</p>
                                    <p className="text-xl font-bold text-cyan-400">
                                      {message.missionData.data.daily_volume_gb} GB
                                    </p>
                                  </div>

                                  <div className="p-3 bg-slate-700/30 rounded-lg">
                                    <p className="text-xs text-gray-400">Downlink Speed</p>
                                    <p className="text-xl font-bold text-green-400">
                                      {message.missionData.data.downlink_mbps} Mbps
                                    </p>
                                  </div>

                                  {message.missionData.data.compression && (
                                    <div className="p-3 bg-slate-700/30 rounded-lg">
                                  ...
                                  {message.missionData.data.storage_per_sat_gb && (
                                    <div className="p-3 bg-slate-700/30 rounded-lg">
                                      <p className="text-xs text-gray-400">Onboard Storage</p>
                                      <p className="text-sm font-semibold text-white">
                                        {message.missionData.data.storage_per_sat_gb} GB/sat
                                      </p>
                                    </div>
                                  )}
                                </div>
                            ...
                            {/* ⭐ NEW SECTION 3: Ground Segment */}
                            {message.missionData.ground && (
                              <div className="bg-slate-800/50 rounded-xl p-5 border border-cyan-500/30">
                                <h4 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                                  <span>🌍</span> Ground Segment
                                </h4>
                                ...
                                <div className="space-y-3">
                                  <div className="flex justify-between p-3 bg-slate-700/30 rounded-lg">
                                    ...
                                    <span className="font-bold text-white">
                                      {message.missionData.ground.stations} stations
                                    </span>
                                  </div>

                                  {message.missionData.ground.locations && message.missionData.ground.locations.length > 0 && (
                                    <div className="p-3 bg-slate-700/30 rounded-lg">
                                      <p className="text-xs text-gray-400 mb-2">Locations:</p>
                                      <div className="flex flex-wrap gap-2">
                                        {message.missionData.ground.locations.map((loc, i) => (
                                          <span key={i} className="px-2 py-1 bg-cyan-600/30 text-cyan-300 text-xs rounded-full">
                                            {loc}
                                          </span>
                                        ))}
                                      </div>
                                  ...
                                  <div className="grid grid-cols-2 gap-3">
                                    <div className="p-3 bg-slate-700/30 rounded-lg">
                                      <p className="text-xs text-gray-400">Passes/Day</p>
                                      <p className="text-lg font-bold text-white">
                                        {message.missionData.ground.passes_per_day}
                                      </p>
                                    </div>

                                    <div className="p-3 bg-slate-700/30 rounded-lg">
                                      <p className="text-xs text-gray-400">Contact Duration</p>
                                      <p className="text-lg font-bold text-white">
                                        {message.missionData.ground.contact_duration_min} min
                                      </p>
                                    </div>
                                  </div>
                                </div>
                            ...
                            {/* ⭐ NEW SECTION 4: Timeline */}
                            {message.missionData.timeline && (
                              <div className="bg-slate-800/50 rounded-xl p-5 border border-cyan-500/30">
                                <h4 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="relative h-2 bg-slate-700 rounded-full overflow-hidden">
                                    <div
                                      ...
                                      style={{
                                        width: `${(message.missionData.timeline.design_months / message.missionData.timeline.total_months) * 100}%`
                                      }}
                                    />
                                  </div>
                                  ...
                                  <div className="grid grid-cols-3 gap-3">
                                    <div className="text-center p-3 bg-slate-700/30 rounded-lg">
                                      <p className="text-xs text-gray-400">Design Phase</p>
                                      <p className="text-lg font-bold text-cyan-400">
                                        {message.missionData.timeline.design_months} months
                                      </p>
                                    </div>

                                    <div className="text-center p-3 bg-slate-700/30 rounded-lg">
                                      <p className="text-xs text-gray-400">Build Phase</p>
                                      <p className="text-lg font-bold text-blue-400">
                                        {message.missionData.timeline.build_months} months
                                      </p>
                                    </div>
                                    ...
                                    <div className="text-center p-3 bg-slate-700/30 rounded-lg">
                                      ...
                                      <p className="text-lg font-bold text-white">
                                        {message.missionData.timeline.total_months} months
                                      </p>
                                    </div>
                                  </div>
                                </div>
                            ...
                            {/* ⭐ NEW SECTION 5: Launch Vehicle */}
                            {message.missionData.launch && (
                              <div className="bg-slate-800/50 rounded-xl p-5 border border-cyan-500/30">
                                <h4 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                                  <span>🚀</span> Launch Vehicle
                                </h4>

                                <div className="grid grid-cols-3 gap-3">
                                  <div className="col-span-3 p-3 bg-gradient-to-r from-orange-900/30 to-red-900/30 rounded-lg border border-orange-500/30">
                                    <p className="text-xs text-gray-400">Selected Vehicle</p>
                                    <p className="text-2xl font-bold text-orange-300">
                                      {message.missionData.launch.vehicle}
                                    </p>
                                  </div>

                                  <div className="p-3 bg-slate-700/30 rounded-lg">
                                    <p className="text-xs text-gray-400">Total Mass</p>
                                    <p className="text-lg font-bold text-white">
                                      {message.missionData.launch.mass_total_kg} kg
                                    </p>
                                  </div>

                                  <div className="col-span-2 p-3 bg-slate-700/30 rounded-lg">
                                    <p className="text-xs text-gray-400">Estimated Cost</p>
                                    <p className="text-lg font-bold text-green-400">
                                      ${message.missionData.launch.estimated_cost_million_usd}M USD
                                    </p>
                                  </div>
                                </div>
                              </div>
                            ...
                            {/* ⭐ NEW SECTION 6: Risk Assessment */}
                            {message.missionData.risks && (
                              <div className="bg-slate-800/50 rounded-xl p-5 border border-cyan-500/30">
                                <h4 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                                ...
                                <div className="space-y-3">
                                  ...
                                  <div className="p-4 bg-slate-700/30 rounded-lg">
                                    ...
                                    <p className="text-sm text-gray-400">
                                      {message.missionData.risks.technical.includes('-')
                                        ? message.missionData.risks.technical.split('-').slice(1).join('-').trim()
                                        : message.missionData.risks.technical
                                      }
                                    </p>
                                  </div>
                                  ...
                                  <div className="p-4 bg-slate-700/30 rounded-lg">
                                    ...
                                    <p className="text-sm text-gray-400">
                                      {message.missionData.risks.financial.includes('-')
                                        ? message.missionData.risks.financial.split('-').slice(1).join('-').trim()
                                        : message.missionData.risks.financial
                                      }
                                    </p>
                                  </div>
                                  ...
                                  <div className="p-4 bg-slate-700/30 rounded-lg">
                                    ...
                                    <p className="text-sm text-gray-400">
                                      {message.missionData.risks.schedule.includes('-')
                                        ? message.missionData.risks.schedule.split('-').slice(1).join('-').trim()
                                        : message.missionData.risks.schedule
                                      }
                                    </p>
                                  </div>
                                </div>
